...
test_name = (
    ('Sessional 1', 'Sessional 1'),
    ('Sessional 2', 'Sessional 2'),
...
class Assign(models.Model):
    ...
    def __str__(self):
        ...
        cr = Subject.objects.get(id=self.course_id)
...
class Attendance(models.Model):
    ...
    date = models.DateField(default='2019-08-09')
    status = models.BooleanField(default='True')

    def __str__(self):
        sname = Student.objects.get(name=self.student)
        cname = Subject.objects.get(name=self.course)
...
class AttendanceTotal(models.Model):
    ...
    def att_class(self):
        ...
        cr = Subject.objects.get(name=self.course)
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Sessional 1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Sessional 1')
                    sc.marks_set.create(name='Sessional 2')
                    sc.marks_set.create(name='Pre-Uniersity')
                    #sc.marks_set.create(name='Event 1')
                    #c.marks_set.create(name='Event 2')
